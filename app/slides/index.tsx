...
const SlidesScreen = () => {
  ...
  const onScroll = (event: NativeSyntheticEvent<NativeScrollEvent>) => {
    ...
    console.log(contentOffset.x, layoutMeasurement.width);
  ...
  return (
    <ThemedView>
      ...
      {currentSlideIndex === items.length - 1 ? (
        ...
        <ThemedButton className="absolute bottom-10 right-10" onPress={() => scrollToSlide(currentSlideIndex + 1)}>
          Siguiente
        </ThemedButton>
      )}
    </ThemedView>
...
const SlideItem = ({ item }: SlideItemProps) => {
  ...
  return (
    ...
    >
      ...
      <ThemedText className="mt-10" type="normal">
        {desc}
      </ThemedText>
    </ThemedView>
  );
