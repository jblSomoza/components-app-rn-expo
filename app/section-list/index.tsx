    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList
          ...
          ListHeaderComponent={() => <ThemedText type='h2'>Houses</ThemedText>}
          renderSectionHeader={({section}) => <ThemedText className='bg-light-background dark:bg-dark-background p-2 roudned' type='normal'>{section.title}</ThemedText>}
          stickySectionHeadersEnabled
          ListFooterComponent={() => <ThemedText type='h2'>End of the list</ThemedText>}
        />
      </ThemedCard>
    </ThemedView>
  );
